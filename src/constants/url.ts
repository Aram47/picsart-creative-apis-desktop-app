...
export const CONSOLE = `https://console.picsart.io?${QUERY_PARAM}` as const

// Additional Links with Query Params
export const PICSART_ENTERPRISE_TERMS =
  `https://picsart.com/developer-guidelines/?${QUERY_PARAM}` as const
export const PRIVACY_POLICY = `https://picsart.com/privacy-policy/?${QUERY_PARAM}` as const
export const TRUST_CENTER = `https://picsart.io/trust/?${QUERY_PARAM}` as const
export const HELP_CENTER = `https://support.picsart.com/hc/en-us?${QUERY_PARAM}` as const
export const PRICING = `https://console.picsart.io/dashboard/usage/?${QUERY_PARAM}`
export const SUPPORT_REQUEST =
  `https://help.picsart.io/hc/en-us/requests/new?${QUERY_PARAM}` as const
export const GENAI_TERMS = `https://picsart.com/genaitermsofuse/?${QUERY_PARAM}` as const
